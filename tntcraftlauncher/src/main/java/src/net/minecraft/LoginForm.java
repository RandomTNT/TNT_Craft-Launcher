...
public class LoginForm extends TransparentPanel
{
  ...
  private TransparentButton optionsButton = new TransparentButton("Обновление");
  ...
  private JScrollPane getUpdateNews()
  {
    ...
    try
    {
      ...
      new Thread() {
        public void run() {
          try {
    		  editorPane.setPage(new URL("http://creeperzone.ru/uploads/startnews.html"));
          } catch (Exception e) {
            e.printStackTrace();
  ...
  private JPanel buildLoginPanel() {
    ...
    TransparentPanel options = new TransparentPanel(gl3);
    //TransparentPanel button = new TransparentPanel(gl4);
    
    TransparentLabel label = new TransparentLabel("Логин:", 4);
    label.setHorizontalAlignment(2);
    titles.add(label);
    //titles.add(new TransparentLabel(" ", 4));
    //titles.add(new TransparentLabel(" ", 4));
    titles.setInsets(0,0,0,10);
    titles.add(userName);
    //values.add(password);
    ...
    values.add(optionsButton);
    values.add(launchButton);
  ...
  private TransparentPanel buildOfflinePanel()
  {
    ...
    if (!canPlayOffline) {
      loginPanel.add(new TransparentLabel("(���� �� ���������)", 4), "South");
    }
